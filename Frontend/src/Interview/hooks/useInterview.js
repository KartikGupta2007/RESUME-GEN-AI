...
export const useInterview = () => {
    ...
    const { loading, setLoading, report, setReport, reports, setReports, user } = context
    ...
    return { loading, report, reports, generateReport, getReportById, getReports, getResumePdf, user }
